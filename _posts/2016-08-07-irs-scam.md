...
The site uses two main Javascript files, functions.js and characters.js -- conveniently named so that we can understand how easily confused the scammers get -- to accomplish its goals. Looking at the smaller file, characters.js, we can see a common function implemented by scam sites: an array unshuffler. 
