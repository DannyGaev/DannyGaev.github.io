...
The site uses two Javascript files, `functions.js`{:.js} and `characters.js`{:.js}, conveniently named so we know how easily confused the scammers are. Looking at the smaller file, characters.js, we can see a common function implemented by scam sites: an array unshuffler. 
